...
/**
 * It allows to capture exceptions in the application as a RuntimeException.
 * @author Jose Francisco Mena Ceca
 * @version 2.0
 */
@SuppressWarnings("serial")
public class GutenbergCatalogException extends RuntimeException {

	public GutenbergCatalogException() {
		super();
	}
	
	public GutenbergCatalogException(String message, Throwable cause) {
		super(message, cause);
	}
	
	public GutenbergCatalogException(String message) {
		super(message);
	}
	
	public GutenbergCatalogException(Throwable cause) {
		super(cause);
	}
}
